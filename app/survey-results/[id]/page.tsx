                        ...
                        .map((item: any, i: number) => (
                          ...
                          >
                            <div className="flex items-center justify-between">
                              ...
                              <OptionMediaDisplay media={item.mediaAsset} />
                            ...
                            {/* Rank Distribution */}
                            {item.rankDistribution &&
                              Object.keys(item.rankDistribution).length > 0 && (
                                <div className="flex gap-2 flex-wrap pt-1">
                                  {Object.entries(item.rankDistribution).map(
                                    ([rank, count]: any) => (
